...
const whatsapp = {
    ...
    "modals": {"fullWidth": true, "highlightMethods": {"dimOutDark": true, "gradient": false, "outline": false}}, 
    "navigationMenu": {
        "accentsType": {"coloring": false, "filling": false}, 
        "drawerPosition": "left", 
        "height": 0, 
        "position": {"horizontal": "center", "vertical": 0}, 
        "signatureIcons": true, 
...
const pathAppIcon = "../assets/foreground_iconY.png"
...
export default presets = [
    ...
    {
        name: 'VK',
        imageSource: require(pathImages+'vk.png'),
        imageLowScale: 1.5,
        options: vk
    },
    ...
    {
        name: 'Telegram',
        imageSource: require(pathImages+'telegram.png'),
        imageLowScale: 1.5,
        options: telegram
    },
    ...
    {
        name: 'WhatsApp',
        imageSource: require(pathImages+'whatsapp.png'),
        imageLowScale: 1.5,
        options: whatsapp
    },
    {
        name: 'Tinkoff',
        imageSource: require(pathImages+'tinkoff.png'),
        imageLowScale: 1.5,
        options: tincoff
    },
    {
        name: 'Instagram',
        imageSource: require(pathImages+'instagram.png'),
        imageLowScale: 1.5,
        options: instagram
    },
]
