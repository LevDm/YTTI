...
const minutes = ['00','01','02','03','04','05','06', '07', '08', '09', '10', '15', '20', '25', '30', '35', '40', '45', '50', '55', '56', '57', '58', '59']

const months = new Array(12).fill(0).map((_, index)=>String(index+1))
...
function TapticalPicker(props){
  ...
  const gesture = useMemo(() => Gesture.Pan()
    ...
    .onUpdate((event)=>{
      ...
      if( DYNAMIC_INDEX.value != index){
        //console.log('v')
        runOnJS(Vibration.vibrate)([0,1])
        DYNAMIC_INDEX.value = index
      }
    ...
    .onEnd((event) => {
      ...
      const balanceIndex = countIndex>0? (ITEMS_COUNT-countIndex) : Math.abs(countIndex)
      const endIndex = balanceIndex+1>ITEMS_COUNT? balanceIndex-ITEMS_COUNT : balanceIndex
